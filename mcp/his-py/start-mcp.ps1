...
# ChatGPT uses a dedicated HTTP entrypoint with relaxed transport security
# so tunnelled/public connector requests are accepted.
...
if ($Mode -eq "ChatGPT") {
  ...
  python mcp\his-py\chatgpt_server.py
} else {
