...
export default function NewIncidentForm({ trackerSessions }: Props) {
  ...
  const [form, setForm] = useState({ occurred_at: new Date().toISOString().slice(0, 16), severity: 5, description: '', location: '', personal_notes: '', notes: '', professional_note: '', outcome: '', substance_use: 'no' as 'no' | 'yes' | 'comedown', police_called: false, was_arrested: false, ambulance_called: false, was_sectioned: false, is_sensitive: false, tracker_session_id: activeSessionId as string | null })
