...
function FieldLine({ label, children }: { label: string; children: React.ReactNode }) { return <div className="space-y-1"><p className="text-[10px] tracking-widest uppercase font-mono text-zinc-500">{label}</p><div>{children}</div></div> }
